...
/// SQLite3PostfixUnaryOperation.PostfixUnaryOperator.IS_TRUE;
...
/// SQLite3BinaryComparisonOperation.BinaryComparisonOperator.LIKE;
...
// assertEquals(
// "((-1) BETWEEN (x'00000000') AND (-1)) -- (INT) 0 explicit collate: null implicit collate:
/// null\n\t((((-1)>=(x'00000000')))AND(((-1)<=(-1)))) -- (INT) 0 explicit collate: null implicit collate:
/// null\n\t\t((-1)>=(x'00000000')) -- (INT) 0 explicit collate: null implicit collate: null\n\t\t\t-1 -- (INT) -1
/// explicit collate: null implicit collate: null\n\t\t\tx'00000000' -- (BINARY) x'00000000' explicit collate: null
/// implicit collate: null\n\t\t((-1)<=(-1)) -- (INT) 1 explicit collate: null implicit collate: null\n\t\t\t-1 -- (INT)
/// -1 explicit collate: null implicit collate: null\n\t\t\t-1 -- (INT) -1 explicit collate: null implicit collate:
/// null\n",
// sQLite3ExpectedValueVisitor0.get());
// }
//
...
// assertEquals(
// "(~ (1)) -- (INT) -2 explicit collate: null implicit collate: null\n\t1 -- (INT) 1 explicit collate: null implicit
/// collate: null\n",
// sQLite3ExpectedValueVisitor0.get());
// }
//
...
// SQLite3BinaryOperation.BinaryOperator sQLite3Expression_SQLite3BinaryOperation_BinaryOperator0 =
/// SQLite3BinaryOperation.BinaryOperator.ARITHMETIC_OR;
...
// SQLite3SetClause.SQLite3ClauseType sQLite3SetClause_SQLite3ClauseType0 =
/// SQLite3SetClause.SQLite3ClauseType.UNION_ALL;
...
/// 0 explicit collate: null implicit collate: null\n\t((0)|(0)) -- (INT) 0 explicit collate: null implicit collate:
...
// SQLite3Case.SQLite3CaseWithoutBaseExpression sQLite3Case_SQLite3CaseWithoutBaseExpression0 = new
/// SQLite3Case.SQLite3CaseWithoutBaseExpression(
...
// assertEquals(
// "^o) -- null explicit collate: null implicit collate: null\n\t^o) -- null explicit collate: null implicit collate:
/// null\n^o) -- null explicit collate: null implicit collate: null\n\t^o) -- null explicit collate: null implicit
/// collate: null\n",
// sQLite3ExpectedValueVisitor0.get());
// }
//
...
/// SQLite3Aggregate.SQLite3AggregateFunction.COUNT;
...
// // SQLite3WindowFunction.WindowFunction sQLite3WindowFunction_WindowFunction0 =
// // SQLite3WindowFunction.WindowFunction.LAG;
...
// SQLite3WindowFunction.WindowFunction sQLite3WindowFunction_WindowFunction0 =
/// SQLite3WindowFunction.WindowFunction.LAST_VALUE;
...
// SQLite3ExpectedValueVisitor sQLite3ExpectedValueVisitor0 = new SQLite3ExpectedValueVisitor();
// SQLite3Aggregate.SQLite3AggregateFunction sQLite3Aggregate_SQLite3AggregateFunction0 =
/// SQLite3Aggregate.SQLite3AggregateFunction.MIN;
...
// SQLite3SetClause.SQLite3ClauseType sQLite3SetClause_SQLite3ClauseType0 =
/// SQLite3SetClause.SQLite3ClauseType.INTERSECT;
...
// SQLite3ExpectedValueVisitor sQLite3ExpectedValueVisitor0 = new SQLite3ExpectedValueVisitor();
// SQLite3BinaryOperation.BinaryOperator sQLite3Expression_SQLite3BinaryOperation_BinaryOperator0 =
/// SQLite3BinaryOperation.BinaryOperator.MINUS;
...
// SQLite3BinaryComparisonOperation.BinaryComparisonOperator
/// sQLite3Expression_BinaryComparisonOperation_BinaryComparisonOperator0 =
/// SQLite3BinaryComparisonOperation.BinaryComparisonOperator.NOT_EQUALS;
// SQLite3BinaryComparisonOperation sQLite3Expression_BinaryComparisonOperation0 = SQLite3BinaryComparisonOperation
...
/// SQLite3WindowFunctionExpression.SQLite3WindowFunctionFrameSpecTerm(
// sQLite3WindowFunctionExpression_SQLite3WindowFunctionFrameSpecTerm_SQLite3WindowFunctionFrameSpecTermKind0);
// SQLite3WindowFunctionExpression.SQLite3WindowFunctionFrameSpecBetween
/// sQLite3WindowFunctionExpression_SQLite3WindowFunctionFrameSpecBetween0 = new
/// SQLite3WindowFunctionExpression.SQLite3WindowFunctionFrameSpecBetween(
...
// SQLite3Expression[] sQLite3ExpressionArray0 = new SQLite3Expression[0];
// SQLite3WindowFunction.WindowFunction sQLite3WindowFunction_WindowFunction0 =
/// SQLite3WindowFunction.WindowFunction.PERCENT_RANK;
// SQLite3WindowFunction sQLite3WindowFunction0 = new SQLite3WindowFunction(sQLite3WindowFunction_WindowFunction0,
// sQLite3ExpressionArray0);
// sQLite3ExpectedValueVisitor0.visit(sQLite3WindowFunction0);
...
// SQLite3Select sQLite3Select0 = new SQLite3Select();
// SQLite3WindowFunction.WindowFunction sQLite3WindowFunction_WindowFunction0 =
/// SQLite3WindowFunction.WindowFunction.RANK;
// SQLite3Expression[] sQLite3ExpressionArray0 = new SQLite3Expression[1];
// sQLite3ExpressionArray0[0] = (SQLite3Expression) sQLite3Select0;
// SQLite3WindowFunction sQLite3WindowFunction0 = new SQLite3WindowFunction(sQLite3WindowFunction_WindowFunction0,
// sQLite3ExpressionArray0);
...
// SQLite3PostfixUnaryOperation.PostfixUnaryOperator
/// sQLite3Expression_SQLite3PostfixUnaryOperation_PostfixUnaryOperator0 =
/// SQLite3PostfixUnaryOperation.PostfixUnaryOperator.ISNULL;
// SQLite3Constant sQLite3Constant0 = SQLite3Constant.createFalse();
// SQLite3InOperation sQLite3Expression_InOperation0 = new SQLite3InOperation(sQLite3Constant0, sQLite3Constant0);
// SQLite3PostfixUnaryOperation sQLite3Expression_SQLite3PostfixUnaryOperation0 = new SQLite3PostfixUnaryOperation(
...
// sQLite3ExpectedValueVisitor0.visit(sQLite3Select0, false);
// assertEquals(
// "\t((0) BETWEEN (0) AND (x'000000000000000000000000000000000000000000')) -- (INT) 1 explicit collate: null implicit
/// collate: null\n\t\t((((0)>=(0)))AND(((0)<=(x'000000000000000000000000000000000000000000')))) -- (INT) 1 explicit
/// collate: null implicit collate: null\n\t\t\t((0)>=(0)) -- (INT) 1 explicit collate: null implicit collate:
/// null\n\t\t\t\t0 -- (INT) 0 explicit collate: null implicit collate: null\n\t\t\t\t0 -- (INT) 0 explicit collate:
/// null implicit collate: null\n\t\t\t((0)<=(x'000000000000000000000000000000000000000000')) -- (INT) 1 explicit
/// collate: null implicit collate: null\n\t\t\t\t0 -- (INT) 0 explicit collate: null implicit collate:
/// null\n\t\t\t\tx'000000000000000000000000000000000000000000' -- (BINARY)
/// x'000000000000000000000000000000000000000000' explicit collate: null implicit collate: null\n",
// sQLite3ExpectedValueVisitor0.get());
// }
//
// @Test
